  ...
  return (
    <div>
      ...
      <About className="row abt-div">
        ...
        <div className="col-md-6 col-sm-12 abtinfo">
          <h4 className="fw-bold">About Company</h4>
          <p className="p1">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
            scelerisque non quam nec viverra. Phasellus suscipit posuere
            faucibus. Morbi et magna tellus. Praesent congue risus quis augue
            aliquet, et congue arcu imperdiet.{" "}
          </p>
          <p className="p2">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
            scelerisque non quam nec viverra.{" "}
          </p>
        </div>
      </About>
